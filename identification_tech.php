...
<!-- End WOWSlider.com BODY section --></td>
  ...
  <tr>
    ...
    <fieldset  style="width: 17em;" class="loginField">
      ...
      <table width="75%" border="0" align="center" cellpadding="0" cellspacing="3">
        ...
        <tr>
          <td colspan="2" align="center"><input name="b1" type="submit" class="button" id="b1" value="S'identifier" /></td>
          </tr>
      </table>
	  </fieldset>
      <p><img src="img/tech.jpg" width="1024" height="300" /></p>
      </form>
    <?php
	if(isset($_POST["b1"]))
	{
	...
	while($res=mysql_fetch_array($sql))
	{
		...
		echo"Veuillez vérifier votre login et/ou mot de passe";
	}
	}
	?></td>
  </tr>
