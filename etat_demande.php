...
<li><a href="contact.php">Contactez-Nous</a></li>
  ...
  $code=$res["code"];
	...
	{
  ?>
            Votre demande est encours d'&eacute;tude<br />
            Vous aurez votre devis le plust&ocirc;t possible<br />
            merci
            <?php
	}
	if($devis!='')
	{
		?>
            <a href="img/<?php echo"$devis"; ?>"><img src="img/icone-telecharger.gif" />Cliquez ICI pour t&eacute;l&eacute;charger votre devis</a><br />
            <a href="installation.php?code=<?php echo"$code"; ?>">Cliquez ICI pour confirmer votre demande d'installation</a></p>
        <?php
	}
			}
	?>
