...
<li><a href="contact.php">Contactez-Nous</a></li>
         ...
         <div id="gmap" style="width:100%; height:400px;"></div>
          <form id="form1" name="form1" method="post" action="">
            <table width="80%" border="0" align="center" cellpadding="5" cellspacing="5">
              ...
              <tr>
                <td colspan="2" align="center"><input type="submit" name="b1" id="b1" value="Confirmer" /></td>
                </tr>
            </table>
          </form>
          <p>&nbsp;</p>
  ...
  $sql= mysql_query("update devis set lat='$lat', lng='$lng' where code='$code'");
 if($sql)
 {
	 ?>
     <script language="javascript">
	 alert("votre demande d'installation à été bien transmis à l'administration de Alerta Qecurity");
	 </script>
        <?php
	}
			}
