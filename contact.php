...
<script>
$(function(){
		   var latlng=new google.maps.LatLng(35.67306007825341,10.100029497375544);
	...
	var info='<div><legend class="legend">Alerta Security</legend><br>Place de la victoire, Kairouan 3100<br><img src="img/tel.jpg"> 77238085</div>';
      ...
      <?php
			   ...
			   ?>
			    ...
			    <form id="contact" name="contact" method="post" action="" onsubmit="return control()">
				  ...
				  <table width="100%" border="0" class="tdform">
                    <tr>
                      <td class="tdform">Votre nom </td>
                      <td><input name="nom" type="text" class="zied" value="" /></td>
                    </tr>
                    <tr>
                      <td class="tdform">Votre pr&eacute;nom</td>
                      <td><input name="prenom" type="text" class="zied" value="" /></td>
                    </tr>
                    <tr>
                      <td class="tdform">Votre adresse mail</td>
                      <td><input name="mail" type="text" class="zied" value="" /></td>
                    </tr>
                    <tr>
                      <td colspan="2" class="tdform">Question/commentaire</td>
                      </tr>
                    <tr>
                      <td><div align="center"></div></td>
                      <td><textarea name="question" cols="30" rows="6" class="zied"></textarea></td>
                    </tr>
                  </table>
				...
				V&eacute;rification de s&eacute;curit&eacute;
				  <table width="100%" border="0">
                    <tr>
                      <td> Entrez les deux mots ci-dessous </td>
                    </tr>
                    <tr>
                      <td><div align="center"><img src="captcha.php" alt="captcha" align="middle" /></div></td>
                    </tr>
                    <tr>
                      <td align="center">
                        <input name="captcha" type="text" class="zied" />
                      </td>
                    </tr>
                  </table>
...
echo " Veuillez recopier le code  correctement";
}
else {
...
</div></div></div><div class="twpara-row row-fluid"></div></div><div id="top-sb" class="span3"><div id="awRH5GTA" class="tw-para twps-panel"><h2>Nos Produits</h2><div class="ptext"><ul><?php
		  include("connection.php");
