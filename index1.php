...
<!-- End WOWSlider.com BODY section --></td>
  ...
  <tr>
    <td height="700" valign="top"><img src="img/accueil.jpg" width="1024" height="600" usemap="#Map" border="0" />
    </td>
  </tr>
  <tr>
...
<map name="Map" id="Map">
  <area shape="circle" coords="212,457,118" href="identification_tech.php" />
  <area shape="circle" coords="840,149,111" href="identification_admin.php" />
</map>
</body>
</html>